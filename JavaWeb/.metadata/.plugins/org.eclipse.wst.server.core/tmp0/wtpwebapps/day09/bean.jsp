<%@page import="sylu.javaweb.Customer"%>
...
<body>
	...
	<jsp:useBean id="customer" class="sylu.javaweb.Customer" 
		scope="request"></jsp:useBean>
	
	<jsp:useBean id="customer2" beanName="sylu.javaweb.Customer"
		type="java.lang.Object" scope="request"></jsp:useBean>
		
	<%-- 
		Object customer2 = request.getAttribute("customer2");
		if(customer2){
			customer2 = Class.forName("sylu.javaweb.Customer").newInstance();
	...
	<%-- 
		//1. 从 scope(session) 中获取 id(customer) 属性值, 赋给 class(sylu.javaweb.Customer) 
		//类型的 id(customer) 变量
		...
		if(customer == null){
			customer = (Customer)Class.forName("sylu.javaweb.Customer").newInstance();
