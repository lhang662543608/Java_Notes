 ...
 *         如果写出到的文件存在，则对原文件进行覆盖。（默认情况下，从头覆盖）。
 * 4.可以通过相关操作，实现RandomAccessFile“插入”数据的效果。
 * @author lhang
 * @create 2019-06-29 17:42
 */
public class RandomAccessFileTest {
    ...
    public void test()  {
        ...
        try {
            //1.
            raf1 = new RandomAccessFile(new File("爱情与友情.jpg"),"rw");
