...
//		System.out.println(sql);
    ...
    public void testPreparedStatement() {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1, "lhang");
            ...
            JDBCTools.releaseDB(preparedStatement, connection);
        }
    }
    @Test
    ...
    /**
     * 打印学生信息;若学生存在则打印具体信息，若不存在则打印查无此人。
     *
     * @param student
     */
    ...
    /**
     * 具体查询学生信息，返回一个Student对象。若不存在则返回null。
     *
     ...
     * 从控制台读入一个整数，确定查询的类型。
     *
     * @return 1，身份证查询 2.准考证查询  其他的无效，并提示用户从新输入。
     */
    private int getSearchTypeFromConsole() {
        System.out.println("请输入查询类型：1.身份证号查询 2.准考证号查询");
        Scanner scanner = new Scanner(System.in);
