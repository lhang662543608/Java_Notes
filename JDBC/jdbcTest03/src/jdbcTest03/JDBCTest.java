...
public class JDBCTest {
    ...
    public void readBlob(){
        ...
        try {
            ...
            if(resultSet.next()){
                ...
                OutputStream out = new FileOutputStream("myschool.jpg");
    ...
    public void testInsertBlob(){
        ...
        try {
            ...
            preparedStatement.setString(1, "xiaohua");
            preparedStatement.setString(2, "xiaohua@163.com");
            preparedStatement.setDate(3,
                    new Date(new java.util.Date().getTime()));

            InputStream inputStream = new FileInputStream("sylu.jpg");
